	...
	return (
		<>
			...
			{tooltipState.visibility === 'Visible' ? (
				<TheTooltip pageX={tooltipState.pageX} pageY={tooltipState.pageY}>
					{props.children[0]}
				</TheTooltip>
			) : (
				<></>
...
function TheTooltip(props: TheTooltipProps) {
	...
	return createPortal(
		<>
			...
			<div
				style={{
					left: `${props.pageX - TOOLTIP_SIZE / 2}px`,
					top: `${props.pageY + (flipped ? 0 : -TOOLTIP_SIZE)}px`
				}}
