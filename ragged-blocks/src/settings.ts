...
export class ToggleSettingView extends SettingView {
	...
	static new<O extends ViewSettings & Pick<{ [key: string]: boolean }, K>, K extends string>(
		key: K,
		obj: O,
		description: string
	): ToggleSettingView {
...
export class NumberSettingView extends SettingView {
	...
	static new<O extends ViewSettings & Pick<{ [key: string]: number }, K>, K extends string>(
		key: K,
		obj: O,
		description: string
	): NumberSettingView {
