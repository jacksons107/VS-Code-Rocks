import {
	...
	offsetPath,
	pointInPath,
	rectPathIntersectionArea,
	tryToRemoveAntiknobs,
	tryToRemoveClockwiseCorners
} from '../src/polygon';
...
test('Can remove eastward facing antiknob', () => {
	...
	const path = [p(0, 0), p(0, 20), p(15, 20), p(15, 15), p(5, 15), p(5, 5), p(10, 5), p(10, 0)];

	const expectation = [p(0, 0), p(0, 20), p(15, 20), p(15, 15), p(10, 15), p(10, 0)];
...
test('Can remove southward facing antiknob', () => {
	...
	const path = [p(0, 0), p(0, 10), p(5, 10), p(5, 5), p(10, 5), p(10, 15), p(15, 15), p(15, 0)];

	const expectation = [p(0, 0), p(0, 10), p(10, 10), p(10, 15), p(15, 15), p(15, 0)];
...
test('Can remove west facing antiknob', () => {
	...
	const path = [p(0, 0), p(0, 5), p(5, 5), p(5, 10), p(0, 10), p(0, 15), p(15, 15), p(15, 0)];

	const expectation = [p(0, 0), p(0, 15), p(15, 15), p(15, 0)];
...
test('Can remove a corner', () => {
	...
	const path = [p(0, 0), p(0, 10), p(10, 10), p(10, 5), p(5, 5), p(5, 0)];

	const expectation = [p(0, 0), p(0, 10), p(10, 10), p(10, 0)];
...
test('Can remove a different corner', () => {
	...
	const path = [p(5, 0), p(5, 5), p(0, 5), p(0, 10), p(10, 10), p(10, 0)];
...
test('Can remove two corners', () => {
	...
	const path = [p(0, 0), p(0, 5), p(5, 5), p(5, 10), p(10, 10), p(10, 5), p(5, 5), p(5, 0)];
...
test('Can offset a square', () => {
	const path = [p(0, 0), p(0, 10), p(10, 10), p(10, 0)];

	const expectation = [p(4, 6), p(6, 6), p(6, 4), p(4, 4)];
...
test('Can offset a polygon with a clockwise turn', () => {
	...
	const expectation = [p(7, 7), p(2, 7), p(2, 8), p(8, 8), p(8, 2), p(7, 2)];
...
test('Can find the intersection area of a path with a rectangle inside of it', () => {
	...
	// ^ ^ ^ ^
	// 0 3 6 9
	const path = [p(0, 0), p(0, 9), p(9, 9), p(9, 0)];
