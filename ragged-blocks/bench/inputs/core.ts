 ...
 * @internal
 */
export function flatMap<T, U extends {}>(
	array: readonly T[] | undefined,
 ...
 * @internal
 */
export const elementAt: <T>(array: readonly T[] | undefined, offset: number) => T | undefined =
	!!Array.prototype.at
...
export function singleOrUndefined<T>(array: readonly T[] | undefined): T | undefined {
	return array !== undefined && array.length === 1 ? array[0] : undefined;
}
...
/** @internal */
export function singleOrMany<T>(array: readonly T[] | undefined): T | readonly T[] | undefined {
	return array !== undefined && array.length === 1 ? array[0] : array;
}
...
): { [P in K as `${P}`]?: T[] }; // eslint-disable-line no-restricted-syntax
export function groupBy<T, K extends string | number | boolean | null | undefined>(
	values: readonly T[] | undefined,
	keySelector: (value: T) => K
): { [P in K as `${P}`]?: T[] } {
